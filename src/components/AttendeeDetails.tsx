...
const AttendeeDetails: React.FC = () => {
  ...
  return (
    <main className="p-8 max-w-3xl mx-auto rounded-xl shadow-lg bg-[#031d21]">
      <div className="border border-[#24A0B5] bg-[#08252B] rounded-3xl p-6 ">
        ...
        <div className="border border-[#249fb53f]  rounded-xl text-left p-2">
          <p className="text-md  text-left font-semibold text-white mb-4">
            Upload Profile Photo
          </p>
          <div className="md:border border-[#24A0B5] md:bg-[#0d2f35] shadow-inner rounded-xl p-4">
            <div
              onDrop={handleFileDrop}
              onDragOver={(e) => e.preventDefault()}
              className="md:w-2/4 h-52 w-3/4 m-auto md:h-32 overflow-visible body is there border-2 border-[#24A0B5] rounded-3xl bg-[#1b6572] text-white flex justify-center items-center  text-center"
            >
              {photo ? (
                <img
        ...
        <div className="md:flex-row-reverse md:flex m-auto w-full justify-between mt-4">
          ...
          <button
            onClick={() => navigate("/")}
            className="w-full m-1 bg-[#0a3036] border-[#24A0B5] border text-white py-2 rounded-md hover:bg-gray-700"
          >
            Back
          </button>
        </div>
